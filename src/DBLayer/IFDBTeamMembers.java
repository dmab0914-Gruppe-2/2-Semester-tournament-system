...
public interface IFDBTeamMembers {
	 ...
	 * @param teamID	The id of the tournament, to check for.
	 ...
	 * @param teamID	THe id of the team the user should be added to.
	 * @param userID	The user to add to the tournament.
	 */
	 ...
	 * @param teamID	The id of the team to remove the users from.
	 */
